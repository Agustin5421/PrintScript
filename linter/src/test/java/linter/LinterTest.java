...
public class LinterTest {
    ...
    public void testArgumentsRuleIsNotMet() {
        ...
        assertEquals("Warning from (row: 0, col: 0) to (row: 0, col: 0): Expression is not allowed as CallExpression argument", report);
    }
    ...
    public void testRulesNotMet() {
        ...
        String report = linter.linter(program, rules);
        assertEquals("Warning from (row: 0, col: 0) to (row: 0, col: 0): Identifier test_name does not follow camelCase convention\n" +
                "Warning from (row: 0, col: 0) to (row: 0, col: 0): Expression is not allowed as CallExpression argument", report);
    }
}
