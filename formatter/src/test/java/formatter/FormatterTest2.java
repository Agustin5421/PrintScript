...
import formatter.newimpl.FormatterInitializer;
import formatter.newimpl.MainFormatter2;
...
public class FormatterTest2 {
  private final String jsonOptions =
      """
            ...
            """;
  private final MainFormatter2 formatter = FormatterInitializer.init(jsonOptions);
