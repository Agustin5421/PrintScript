...
public class FormatterVisitor2 implements NodeVisitor {
  ...
  public NodeVisitor visitBinaryExpression(BinaryExpression binaryExpression) {
    ...
    return new FormatterVisitor2(strategies, strategy.apply(binaryExpression, this));
  }
  ...
  public FormattingStrategy getStrategy(AstNode node) throws IllegalArgumentException {
    ...
    if (strategy == null) {
      throw new IllegalArgumentException("Strategy not found for type: " + node.getType());
    }
    return strategy;
  }
}
