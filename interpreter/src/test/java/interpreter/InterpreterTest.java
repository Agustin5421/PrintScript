...
public class InterpreterTest {
    ...
    public void testBinaryExpressionPrinting() {
        ...
        BinaryExpression binaryExpression = new BinaryExpression(identifier, new NumberLiteral(42.5, defaultPosition, defaultPosition), "+");
        ...
        List<ASTNode> statements = List.of(variableDeclaration, variableDeclaration2, callExpression, callExpression1);
        Program program = new Program(statements);

        Interpreter interpreter = new Interpreter();
        VariablesRepository repository =  interpreter.executeProgram(program);

        assertEquals(42.5, repository.getVariable("x"));
        assertEquals(85.0, repository.getVariable("y"));
    }
    ...
    public void testBinaryExpressionPrintForReal() {
        ...
        BinaryExpression binaryExpression = new BinaryExpression(identifier, new NumberLiteral(42.5, defaultPosition, defaultPosition), "+");
        Identifier printName = new Identifier("println", new Position(6, 0), new Position(6, 6));
        CallExpression callExpression = new CallExpression(printName, List.of(binaryExpression), false, new Position(6, 0), new Position(6, 6));
    ...
    public void testBinaryExpressionStringAndNumberPrint() {
        ...
        BinaryExpression binaryExpression = new BinaryExpression(new StringLiteral("a", defaultPosition, defaultPosition), identifier, "+");
        Identifier printName = new Identifier("println", new Position(6, 0), new Position(6, 6));
        CallExpression callExpression = new CallExpression(printName, List.of(binaryExpression), false, new Position(6, 0), new Position(6, 6));
