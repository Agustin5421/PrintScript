...
public class InterpreterPrintStatementTest {
    ...
    public void testArithOp() {
        ...
        assertEquals(
                17, repository.getNewVariable(new VariableIdentifier("numberResult")).value());
    }
    ...
    public void testArithOpDec() {
        ...
        assertEquals(
                1.57, Double.parseDouble(printedValues.get(0)));
    }
    ...
    public void testDeclareAssign() {
        ...
        List<String> printedValues = interpreter.interpret(code);
        assertEquals(
                5, Double.parseDouble(printedValues.get(0)));
    }
    ...
    public void testStrConcatNumb() {
        ...
        List<String> printedValues = interpreter.interpret(code);
        assertEquals(
                "hello world 1", printedValues.get(0));
    }
