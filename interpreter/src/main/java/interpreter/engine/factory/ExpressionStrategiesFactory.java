...
import interpreter.engine.strategy.expression.binary.BinaryExpressionStrategy;
import interpreter.engine.strategy.expression.binary.BinaryProcedure;
import interpreter.engine.strategy.expression.binary.BooleanFailingProcedure;
import interpreter.engine.strategy.expression.binary.NumberOperationProcedure;
import interpreter.engine.strategy.expression.binary.StringOperationProcedure;
...
import interpreter.engine.strategy.expression.literal.BooleanLiteralFactory;
import interpreter.engine.strategy.expression.literal.LiteralFactory;
import interpreter.engine.strategy.expression.literal.LiteralHandler;
import interpreter.engine.strategy.expression.literal.LiteralStrategy;
import interpreter.engine.strategy.expression.literal.NumberLiteralFactory;
import interpreter.engine.strategy.expression.literal.StringLiteralFactory;
