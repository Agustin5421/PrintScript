...
public class ValueCollector implements NodeVisitor {
    ...
    // Only works with Identifier, Literals, BinaryExpressions and CallExpression (readInput() and readEnv()).
    private final StrategyContainer<AstNodeType> strategies;
    private final VariablesRepository variablesRepository;

    public ValueCollector(StrategyContainer<AstNodeType> strategies, Literal<?> value, VariablesRepository variablesRepository) {
        this.value = value;
